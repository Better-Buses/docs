...
- *Sensors*: Dedicated VMs running Python simulators to replicate urban telemetry. They model two distinct areas (each with one bus and five stops), injecting stochastic delays upon arrival at bus stops to accurately mimic real-world traffic fluctuations and passenger boarding friction.
